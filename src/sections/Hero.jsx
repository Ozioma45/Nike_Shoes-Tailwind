...
const Hero = () => {
  // Add state to keep track of the current big shoe image
  const [bigShoeImg, setBigShoeImg] = useState(bigShoe1);

  // Function to change the big shoe image
  const changeBigShoeImg = (newBigShoeImg) => {
    setBigShoeImg(newBigShoeImg);
  };
  return (
    <section
      id="home"
      ...
      <div
        ...
        <p className="font-montserrat  text-slate-gray text-lg mb-14 mt-6 leading-8 sm:max-w-sm">
      ...
      justify-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
        <img
          src={bigShoeImg}
          alt="Shoe Collection"
          width={610}
